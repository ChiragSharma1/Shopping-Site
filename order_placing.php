...
{
$result = mysqli_query($con, $query);
$rown1 = mysqli_fetch_array($result);
...
echo "<hr>";
$query2="SELECT product_name,product_image,product_link,product_description,price FROM products WHERE product_id='$p_id'";
...
echo "SELECT ADDRESS  <input type='text' name='product_id' value='$p_id' style='width:0%;height:0%' readonly><input type='text' name='price' value='$total' style='width:0%;height:0%' readonly><input type='text' name='quantity' value='$p_qty' style='width:0%;height:0%' readonly><br/>";
