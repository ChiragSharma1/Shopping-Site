...
<body style="text-align:center">
	<?php
		...
		include("../auth.php");
    include('navbar.php');
	$queryn1="SELECT quantity FROM products WHERE product_id=12";
  ...
  <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
    ...
    <span class="sr-only">Next</span>
		 ...
		 <div class="col-md-7">
			 ...
			 <h2>Automatic Mens Chronograph Watch 116506</h2>
			 <p>Product Code:ROC1220</p>
			 <img src="star.png" class="stars">
			 <p class="price"> Rs3,54,900</p>
			 ...
			 <input type="text" name="product_id" value="12" style="width:0%;height:0%;display:none" readonly>
			...
			<input type="text" name="input" value="12" style="width:0%;height:0%;font-size:0%;display:none" readonly>
