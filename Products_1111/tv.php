...
<body style="text-align:center">
	<?php
		...
		include("../auth.php");
		include('navbar.php');
		$queryn1="SELECT quantity FROM products WHERE product_id=10";
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="tv/tv1.jpg" class="d-block w-100" alt="First slide" height="500px" width="300px">
    </div>
    <div class="carousel-item">
      <img src="tv/tv2.jpg" class="d-block w-100" alt="Second slide" height="500px" width="300px">
    </div>
    <div class="carousel-item">
      <img src="tv/tv3.jpg" class="d-block w-100" alt="Third slide"height="500px" width="300px">
    </div>
  </div>
  <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
    ...
    <span class="sr-only">Next</span>
		 ...
		 <div class="col-md-7">
			 ...
			 <h2>Sony X750H 55-inch 4K Ultra HD LED TV -2020 Model</h2>
			 <p>Product Code:SORC2030</p>
			 <img src="star.png" class="stars">
			 <p class="price"> Rs50,450</p>
			 ...
			 <input type="text" name="product_id" value="10" style="width:0%;height:0%;display:none" readonly>
			...
			<input type="text" name="input" value="10" style="width:0%;height:0%;font-size:0%;display:none" readonly>
