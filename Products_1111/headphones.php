...
<body style="text-align:center">
	...
	<?php
		...
		include("../auth.php");
    include('navbar.php');
	$queryn1="SELECT quantity FROM products WHERE product_id=4";
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="headphones/headphones1.jpg" class="d-block w-100" alt="First slide" height="500px" width="300px">
    </div>
    <div class="carousel-item">
      <img src="headphones/headphones2.jpg" class="d-block w-100" alt="Second slide" height="500px" width="300px">
    </div>
    <div class="carousel-item">
      <img src="headphones/headphones3.jpg" class="d-block w-100" alt="Third slide"height="500px" width="300px">
    </div>
  </div>
  <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
    ...
    <span class="sr-only">Next</span>
		 ...
		 <div class="col-md-7">
			 ...
			 <h2>Boat Latest Headphones</h2>
			 <p>Product Code:BOA2020</p>
			 <img src="star.png" class="stars">
			 <p class="price"> Rs2,000</p>
			 ...
			 <input type="text" name="product_id" value="4" style="width:0%;height:0%;display:none" readonly>
			...
			<input type="text" name="input" value="4" style="width:0%;height:0%;font-size:0%;display:none" readonly>
