...
<body style="text-align:center">
	<?php
		...
		include("../auth.php");
    include('navbar.php');
	$queryn1="SELECT quantity FROM products WHERE product_id=9";
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="trollybag/trollybag1.jpg" class="d-block w-100" alt="First slide" height="500px" width="300px">
    </div>
    <div class="carousel-item">
      <img src="trollybag/trollybag2.jpg" class="d-block w-100" alt="Second slide" height="500px" width="300px">
    </div>
    <div class="carousel-item">
      <img src="trollybag/trollybag3.jpg" class="d-block w-100" alt="Third slide"height="500px" width="300px">
    </div>
  </div>
  <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
    ...
    <span class="sr-only">Next</span>
		 ...
		 <div class="col-md-7">
			 ...
			 <input type="text" name="product_id" value="9" style="width:0%;height:0%;display:none" readonly>
			...
			<input type="text" name="input" value="9" style="width:0%;height:0%;font-size:0%;display:none" readonly>
