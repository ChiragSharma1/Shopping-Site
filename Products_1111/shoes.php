...
<body style='text-align:center'>
	<?php
		...
		include("../auth.php");
    include('navbar.php');
	$queryn1="SELECT quantity FROM products WHERE product_id=7";
  ...
  <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
    ...
    <span class="sr-only">Next</span>
		 ...
		 <div class="col-md-7">
			 ...
			 <input type="text" name="product_id" value="7" style="width:0%;height:0%;display:none" readonly>
			...
			<input type="text" name="input" value="7" style="width:0%;height:0%;font-size:0%;display:none" readonly>
