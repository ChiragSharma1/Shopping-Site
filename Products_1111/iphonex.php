...
<body style="text-align:center">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="iPhone/img1.jpg" class="d-block w-100" alt="First slide" height="500px" width="300px">
    </div>
    <div class="carousel-item">
      <img src="iPhone/img2.jpg" class="d-block w-100" alt="Second slide" height="500px" width="300px">
    </div>
    <div class="carousel-item">
      <img src="iPhone/img3.jpg" class="d-block w-100" alt="Third slide"height="500px" width="300px">
    </div>
  </div>
