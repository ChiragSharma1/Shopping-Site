  ...
  <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
    ...
    <span class="sr-only">Next</span>
		 ...
		 <div class="col-md-7">
			 ...
			 <input type="text" name="product_id" value="11" style="width:0%;height:0%" readonly>
			...
			<input type="text" name="input" value="11" style="width:0%;height:0%;font-size:0%" readonly>
